...
<html lang="en">
  ...
  <body
    x-data="{ page: 'comingSoon', loaded: true, darkMode: false, stickyMenu: false, sidebarToggle: false, scrollTop: false, userNavbarToggle: false }"
    x-init="
  ...
  >
    ...
    <div class="fixed bottom-8 right-6 z-50 flex flex-col gap-1.5">
      ...
      <div x-data="{ show: false }"
          ...
          <button
            class="inline-flex w-11 h-11 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
